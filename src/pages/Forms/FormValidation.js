					...
					<div className="col-sm-12">
						...
						<div className="card">
							<div className="card-header">
								<h5 className="card-title mb-2">Custom Bootstrap Form Validation</h5>
						...
						<div className="card">
							<div className="card-header">
								<h5 className="card-title mb-2">Browser defaults</h5>
						...
						<div className="card">
							<div className="card-header">
								<h5 className="card-title mb-2">Server side</h5>
						...
						<div className="card">
							<div className="card-header">
								<h5 className="card-title mb-2">Supported elements</h5>
									...
									<div className="col-sm">
										<form className="was-validated">
											...
											<div className="custom-file">
												<input type="file" className="form-control" id="validatedCustomFile" required />
						...
						<div className="card">
							<div className="card-header">
								<h5 className="card-title mb-2">Tooltips</h5>
