                                ...
                                <Row>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="Class Test" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="English" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="10:00 AM" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="26-11-2020" />
                                            </Form.Group>
                                        </Col>
