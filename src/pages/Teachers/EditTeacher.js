                                    ...
                                    <Row>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="Vincent" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="date" defaultValue="23 Jun 1985" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="date" defaultValue="16 Jul 2015" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                <Form.Label>Qualification</Form.Label>
                                                <Form.Control type="text" defaultValue="Bachelor of Engineering" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="email" defaultValue="vincent20@gmail.com" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="3979 Ashwood Drive" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                <Form.Label>City</Form.Label>
                                                <Form.Control type="text" defaultValue="Omaha" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                        ...
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Control type="text" defaultValue="3979" />
                                            </Form.Group>
                                        </Col>
                                        <Col xs={12} sm={6}>
                                            <Form.Group>
