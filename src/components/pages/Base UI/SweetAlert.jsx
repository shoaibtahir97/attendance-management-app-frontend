                    ...
                    <div className="col-md-12">
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <p>
                            SweetAlert automatically centers itself on the page
                            and looks great no matter if you're using a desktop
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <p>
                            ...
                            built-in types which will show a corresponding icon
                            animation: "warning", "error", "success" and "info".
                            You can also set it as "input" to get a prompt
                            modal. It can either be put in the object under the
                            key "icon" or passed as the third parameter of the
                            function.
                          </p>
                          <button
                            type="button"
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          ...
                          <p>
                            Use{" "}
                            <code>confirmButtonText: "Your text here!"</code>{" "}
