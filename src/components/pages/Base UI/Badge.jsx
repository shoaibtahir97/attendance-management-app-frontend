        ...
        <div className="page-wrapper">
          <div className="content container-fluid">
            ...
            <div className="page-header">
              <div className="row">
                <div className="col">
                  <h3 className="page-title">Badges</h3>
            ...
            <div className="row">
              ...
              <div className="col-xxl-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="text-muted">
                      Use the <code>badge-soft-</code> class with
                      below-mentioned variation to create softer badge.
                    </p>
                    <div className="d-flex flex-wrap gap-2">
            ...
            <div className="row">
              ...
              <div className="col-xxl-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="text-muted">
                      Use the <code>rounded-pill</code> class to make badges
            ...
            <div className="row">
              <div className="col-xxl-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="text-muted">
                      Use the <code>rounded-pill badge-soft-</code> class with
            ...
            <div className="row">
              <div className="col-xxl-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="text-muted">
                      Use the <code>rounded-pill badge-outline-</code> class
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge badge-gradient-secondary">
                        Secondary
                      </span>
            ...
            <div className="row">
              <div className="col-xxl-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="text-muted">
                      Use the below utilities to modify a badge and position it
                      in the corner of a link or button.
                    </p>
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <p className="text-muted">
                      Badges can be used as part of buttons to provide a
                      counter.
                    </p>
                    <div className="d-flex flex-wrap gap-2">
