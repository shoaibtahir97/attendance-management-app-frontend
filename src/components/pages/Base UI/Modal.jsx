        ...
        <div className="page-wrapper">
          <div className="content container-fluid">
            ...
            <div className="page-header">
              <div className="row">
                <div className="col">
                  <h3 className="page-title">Modal</h3>
              ...
              <div className="col-xl-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p>
                      Specify the position for the modal. You can display modal
                      at top, bottom, center or right of page by specifying
              ...
              <div className="col-xl-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p>
                      Display a series of modals one by one to guide your users
                      on multiple aspects or take step wise input.
                    </p>
                    {/* Modal */}
                    <div
                      className="modal fade"
