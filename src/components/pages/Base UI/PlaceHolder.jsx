        ...
        <div className="page-wrapper">
          <div className="content container-fluid">
            ...
            <div className="page-header">
              <div className="row">
                <div className="col">
                  <h3 className="page-title">Placeholders</h3>
              ...
              <div className="col-xl-6">
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="text-muted">
                      ...
                      inside an element or as be added as a modifier class to an
                      existing component.
                    </p>
                    <p aria-hidden="true">
                      <span className="placeholder col-6" />
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="text-muted">
                      Animate placehodlers with <code>.placeholder-glow</code>{" "}
                      or <code>.placeholder-wave</code> to better convey the
