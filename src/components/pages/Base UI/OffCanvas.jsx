        ...
        <div className="page-wrapper">
          <div className="content container-fluid">
            ...
            <div className="page-header">
              <div className="row">
                <div className="col">
                  <h3 className="page-title">Offcanvas</h3>
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p>
                      ...
                      or a button with the <code>data-bs-target</code>{" "}
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p>
                      ...
                      Use the <code>data-bs-scroll</code> attribute to toggle{" "}
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <ul className="ps-0 mb-3">
                      <li>
                        <code>.offcanvas-start</code> places offcanvas on the
                        left of the viewport (shown above)
                      </li>
                      <li>
                        <code>.offcanvas-end</code> places offcanvas on the
                        right of the viewport
                      </li>
                      <li>
                        <code>.offcanvas-top</code> places offcanvas on the top
                        of the viewport
                      </li>
                      <li>
