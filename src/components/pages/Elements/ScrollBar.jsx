...
// import "../../../assets/plugins/scrollbar/custom-scroll";
import "../../../assets/plugins/scrollbar/scrollbar.min";
            ...
            <div className="row">
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-3">
                              <p>
                                ...
                                packages and web page editors.It was popularised
              ...
              <div className="col-md-6">
                <div className="card">
                  ...
                  <div className="card-body vertical-card-body">
              ...
              <div className="col-md-6">
                <div className="card">
                  ...
                  <div className="card-body visible-scroll-body">
                    <div className="scroll-bar-wrap">
