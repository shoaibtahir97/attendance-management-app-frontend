  ...
  const column = [
    {
      ...
      render: (text, record) => (
        <>
          <Link to="/viewinvoice">{record.Invoicenumber}</Link>
        </>
      ),
...

    {
      ...
      sorter: (a, b) => a.Lastinvoice.length - b.Lastinvoice.length,
    },
    {
      title: "Next invoice",
      dataIndex: "Nextinvoice",
      sorter: (a, b) => a.Nextinvoice.length - b.Nextinvoice.length,
    },
    {
      title: "Status",
      dataIndex: "Status",
          ...
          <div className="row align-items-center">
            <div className="col">
              ...
              <ul className="breadcrumb">
                ...
                <li className="breadcrumb-item active">Invoices Recurring</li>
              </ul>
            </div>
                ...
                <ul className="app-listing">
                  ...
                  <li>
                    <div className="multipleSelection">
                      ...
                      >
                        <p class="mb-0">
                          <i class="fas fa-bookmark me-1 select-icon"></i> By
                          Category
                        </p>
                        <span class="down-icon">
                          <i class="fas fa-chevron-down"></i>
                ...
                <div className="col-lg-8 col-md-8">
                  <div className="invoices-tabs">
                    <ul>
                      ...
                      <li>
                        <Link to="/invoicerecurring" className="active">
                          Recurring
                        </Link>
                      </li>
                      <li>
            ...
            <div className="card card-table">
              <div className="card-body">
                <div className="table-responsive">
                  <Table
                    class="table table-stripped table-hover datatable thead-light "
                    pagination={{
