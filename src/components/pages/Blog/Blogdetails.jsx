                ...
                <div className="blog-view">
                  <div className="blog-single-post">
                    ...
                    <div className="blog-image">
                      <Link to="#">
                        <img alt="" src={"blogdetail"} className="img-fluid" />
                      </Link>
                    </div>
                        ...
                        <ul>
                          <li>
                            <div className="post-author">
                              <Link to="/profile">
                                <img src={"avatar14"} alt="Post Author" />{" "}
                    ...
                    <div className="card-body pb-0">
                      <ul className="comments-list">
                        <li>
                          <div className="comment">
                            <div className="comment-author">
                              <img className="avatar" alt="" src={"avatar13"} />
                            </div>
                              ...
                              <div className="comment">
                                ...
                                <div className="comment-block">
                                  ...
                                  <p>
                                    ...
                                    pellentesque urna consectetur adipiscing
                                    elit. Nam viverra euismod.
                                  </p>
                                  <Link className="comment-btn" to="#">
                                    <i className="fa fa-reply me-2" /> Reply
                                  </Link>
                        ...
                        <li>
                          <div className="comment">
                            <div className="comment-author">
                              <img className="avatar" alt="" src={"avatar11"} />
                            </div>
                            <div className="comment-block">
                              <div className="comment-by">
                                <h5 className="blog-author-name">
